	...
	exportSets() {
		return this.sets.map((set) => {
			...
			return {
				...
				entrant1ID: leftEntrant ? leftEntrant.entrantID : void 0,
				entrant2ID: rightEntrant ? rightEntrant.entrantID : void 0,
				entrant1Result,
				entrant2Result,
				entrant1Score,
				entrant2Score,
				entrant1NextSetID: parentSet ? `${parentSet.setId}` : void 0,
				entrant2NextSetID: parentSet ? `${parentSet.setId}` : void 0,
				entrant1PrevSetID: leftSet ? `${leftSet.setId}` : leftUpperBracketSet ? `${leftUpperBracketSet.setId}` : void 0,
				entrant2PrevSetID: rightSet ? `${rightSet.setId}` : rightUpperBracketSet ? `${rightUpperBracketSet.setId}` : void 0,
				games: [],
				other: {
					matchLimit,
					nextWinnerSet: parentSet ? `${parentSet.setId}` : void 0,
					nextLoserSet: loserSet && `${loserSet.setId}`,
					nextLeftWinnerSlot: parentSet ? `${parentSet.setId}` : void 0,
					nextRightWinnerSlot: parentSet ? `${parentSet.setId}` : void 0,
					nextLeftLoserSlot: loserSet && loserSet.leftUpperBracketSet && loserSet.leftUpperBracketSet.setId === setId ? loserSet.setId : void 0,
					nextRightLoserSlot: loserSet && loserSet.rightUpperBracketSet && loserSet.rightUpperBracketSet.setId === setId ? loserSet.setId : void 0,
